...
#ifdef VENDOR_EDIT
/* wangdengwen@oplus.com add for QC torch status change */
...
void smblib_hvdcp_detect_enable(struct smb_charger *chg, bool enable)
{
	...
	u8 mask;
	#ifndef VENDOR_EDIT
	/* wangdengwen@oplus.com  changed PD adapter compatible at 6125Q */
...
static void opluschg_usbtemp_dischg(void)
{
	...
	//add by wangdengwen@oplus.com for bug(2661692) of 19375
	//-------------------------start-----------------------
...
static int smb5_probe(struct platform_device *pdev)
{
	...
	int rc = 0;
#ifdef VENDOR_EDIT
	/* wangdengwen@oplus.com  for QC2.0 adapter compatibility*/
	int flag;
	union power_supply_propval ret = {0, };
#endif
